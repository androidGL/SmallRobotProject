...
import static com.pcare.common.base.Constant.APPID_XFYUN;
...
public class WakeUtil {
    ...
    private static String mPKG,mCLS;
    ...
    public static void start(Context context,String pkg,String cls) {
        mContext = context;
        mPKG = pkg;
        mCLS = cls;
        init(context);
    ...
    private static WakeuperListener mWakeuperListener = new WakeuperListener() {
        ...
        public void onResult(WakeuperResult result) {
            ...
            openMainPage(mPKG,mCLS);//打开福娃页面
            TTSUtil.getInstance(mContext).speaking("我在我在啊");
    ...
    private static String getResource(Context context) {
        final String resPath = ResourceUtil.generateResourcePath(context, ResourceUtil.RESOURCE_TYPE.assets, "ivw/" + APPID_XFYUN + ".jet");
        return resPath;
    }
...
//        context.startActivity(Newintent);
    ...
    private static void openMainPage(String pkg,String cls){
        Intent Newintent = new Intent();
        Newintent.setComponent(new ComponentName(pkg,cls));//InquiryProject    com.example.inquiryproject
